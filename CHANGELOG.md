...
### Notes
- Goal `f0004294` tracks the PR2 dispatch-site implementation. 5/7 shipped. Remaining: `SubagentStart` + `SubagentStop` (low priority — only needed if/when subagent usage becomes common in ecodex).
