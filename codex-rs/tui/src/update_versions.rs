...
/// ecodex release tags look like `v0.146.0` (not upstream openai/codex's
/// `rust-v0.147.0` convention) -- confirmed live against
/// `GET /repos/EmpiricaAI/ecodex/releases/latest`.
