...
fn device_code_prompt(verification_url: &str, code: &str) -> String {
    ...
    // ecodex T81 branding: device-code-flow welcome banner.
    format!(
        "\nWelcome to ecodex [v{ANSI_GRAY}{version}{ANSI_RESET}]\n{ANSI_GRAY}the epistemic agent environment by Empirica · turtles all the way down{ANSI_RESET}\n\
