...
pub struct CodexThreadSettingsOverrides {
    ...
    /// ecodex extension (T78): override the `model_provider` ID. When
    /// set, the session re-resolves the provider and hot-swaps the
    /// session-shared ModelClient.
...
impl CodexThread {
    ...
    fn thread_settings_update(overrides: CodexThreadSettingsOverrides) -> SessionSettingsUpdate {
        ...
        SessionSettingsUpdate {
            ...
            active_permission_profile,
            windows_sandbox_level,
            // ecodex extension (T78): staged provider override for hot-swap.
            model_provider,
            ..Default::default()
        }
    }
