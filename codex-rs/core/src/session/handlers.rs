...
async fn thread_settings_update(
    ...
    SessionSettingsUpdate {
        ...
        model_provider,
        // multi_agent_mode is not a thread-settings override; leave unset here.
...
pub async fn shutdown(sess: &Arc<Session>, sub_id: String) -> bool {
    // SessionEnd hooks fire inside shutdown_session_runtime (upstream converged
    // on ecodex's goal-f0004294 SessionEnd event), while history/tasks/MCP are
    // still alive.
    let _ = &sub_id;
