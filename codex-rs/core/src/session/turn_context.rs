...
impl Session {
    ...
    pub(crate) async fn new_turn_with_sub_id(
        ...
        // ecodex extension (T78): execute the provider hot-swap outside the
        // state lock before emitting config-changed contributors.
